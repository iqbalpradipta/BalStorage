...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "flex h-full flex-col border-r border-sidebar-border bg-sidebar-background text-sidebar-foreground transition-all duration-300 ease-in-out glass-sidebar relative z-30",
        collapsed ? "w-16" : "w-64",
      )}
    >
      {/* Brand Header */}
      <div className="flex items-center justify-between p-4 border-b border-sidebar-border/30 h-14">
        {!collapsed ? (
        ...
        <Button
          ...
          className={cn(
            "h-7 w-7 rounded-md hover:bg-sidebar-accent hover:text-sidebar-accent-foreground border border-sidebar-border/20 absolute -right-3 top-3.5 bg-background shadow-md hidden md:flex",
      ...
      <div className="p-3 border-t border-sidebar-border/30">
        <Link
          href="/profile"
          className={cn(
            "flex items-center gap-3 rounded-xl p-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all duration-200",
